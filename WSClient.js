...
class Client {
  constructor(config){
      this.awsClient = this.setupAWSClient(config);
  }

  setupAWSClient(config){
    ...
    console.log('setupAWSClient', awsClient);
    return awsClient;
  }
  ...
  async send(connection, payload){
      ...
      // console.log('sending', this.awsClient)
      ...
      await this.awsClient.postToConnection({
          ...
          if (err.statusCode === 410) {
              ...
              console.log('Error: stale connection');
          }
      });
